...
int brightness=100;                          // led brightness percent
...
{
    int args=0, n,ch, oset=0,rgbdata,r,g,b,patterndata;
...
//                           patterndata = wave_pattern[ch][(n+oset) % 8]; 
                        ...
                        r = r * patterndata * brightness / 100 / 100;
                        g = g * patterndata * brightness / 100 / 100;
